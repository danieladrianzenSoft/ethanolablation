function twoCompartment_Ethanol051619

clear
clc

measurements = load('DataVsTime051619.csv');
...
thickness = [2.5,2.5,2.1,2.6,2.8]; %%Measured after ethanol, may understimate actual thickness.
h_S = mean(thickness/10); %convert mm to cm
h_OH = 1; %cm
t = linspace(0,70*60,1001);
