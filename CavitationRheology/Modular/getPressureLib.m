classdef getPressureLib
    methods(Static)
        function p = pressure_newtonian_fluid_plus_solid(t, r, ind_r_cavity, r_needle, r_tot, lambda, phi, k_c, k_t, Q_needle, dlambdadt)
            ...
            p(ind_r_cavity + 1 : end) = ((Q_needle * phi) / (pi * k_t)) * ((1 ./ r(ind_r_cavity+1:end)) - (1 / r_tot)) + ...
                r_needle * (phi/k_t) * dlambdadt  * (r - r_tot);
        end
