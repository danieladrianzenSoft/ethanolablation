function [t2,PsurfaceC,tm,MsurfaceC,R2,D_S] = twoCompartment_Ethanol011619

clear
clc

measurements = load('DataVsTime011619.csv');
...
ylabel('Ethanol concentration (normalized)','FontSize',18,'FontWeight','Bold')
title('Representative Measurements of Ethanol Concentration vs Time','FontSize',18,'FontWeight','Bold')
XT = get(gca,'XTick');
set(gca,'FontSize',16)
YT = get(gca,'YTick');
set(gca,'FontSize',16)
...
thickness = 2.22;
%thickness = [2.1,3.7,2.9,3.5,2.9];
h_S = mean(thickness/10); %convert mm to cm
h_OH = 1; %cm
t = linspace(0,75*60,1001);
