function [t2,PsurfaceC,tm,MsurfaceC,R2,D_S] = twoCompartment_Ethanol022019S1

clear
clc

measurements = load('DataVsTime022019S1.csv');
...
thickness = [2.6,2.8,2.4,2.2,2.7];
h_S = mean(thickness/10); %convert mm to cm
h_OH = 1; %cm
t = linspace(0,63*60,1001);
