function [t2,PsurfaceC,tm,MsurfaceC,R2,D_S] = twoCompartment_Ethanol021219S1()

clear
clc

measurements = load('DataVsTime021219S1.csv');
...
figure()
plot(t2/60,PsurfaceC,'LineWidth',2,'Color',[147,112,219]/255)
hold on
plot(measurements(:,1),MsurfaceC,'o','Color',[182,215,219]/255,'MarkerFaceColor',[182,215,219]/255)
%plot(TTemp,ConcTemp,'ro')
legend('Model Predictions','Raman Measurements')
xlabel('Time (mins)','FontSize',18,'FontWeight','Bold')
ylabel('Ethanol concentration (normalized)','FontSize',18,'FontWeight','Bold')
title('Representative Measurements and Predictions of Ethanol Concentration vs Time','FontSize',18,'FontWeight','Bold')
XT = get(gca,'XTick');
set(gca,'FontSize',16)
YT = get(gca,'YTick');
set(gca,'FontSize',16)
...
thickness = [2.1,1.6,2.8,2.3,2.6];
h_S = mean(thickness/10); %convert mm to cm
h_OH = 1; %cm
t = linspace(0,71*60,1001);
