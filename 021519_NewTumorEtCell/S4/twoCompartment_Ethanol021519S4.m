function twoCompartment_Ethanol021519S4

clear
clc

measurements = load('DataVsTime021519S4.csv');
measurements(end-4,:) = [];
%measurements(find(measurements(:,1)==46),:) = [];
...
thickness = [1.6,1.6,1.4,1.2,1.8,1.0];
h_S = mean(thickness/10); %convert mm to cm
h_OH = 1; %cm
t = linspace(0,68*60,1001);
